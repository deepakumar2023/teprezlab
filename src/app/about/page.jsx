...
function page() {
  return (
    ...
    <>
      ...
      <SEO
        title="Target Event Prezlab - Live, Virtual & Hybrid Event Production"
        description="Target Event Prezlab is the nation's most reliable live, virtual, and hybrid event production company, working with leading brands and organizations."
        canonical="https://teprezlab.com/target-event"

      />

      <section className="flex items-center justify-center px-4 py-16 bg-white mt-10">
