...
function TestExperience() {
 const experiences = [
  ...
  return (
    ...
    <>
    <main className="bg-[#FAF9F6]  flex items-center justify-center py-3   sm:py-5 md:py-5 px-4  md:px-20">
      <div className=" text-center">
        {/* Heading */}
        <h2 className="text-3xl md:text-4xl font-bold text-gray-900 font-serif">
          Our Signature Experiences
        </h2> 
        <p className="mt-3 text-gray-600  text-[13px] sm:text-[18px]  md:text-[18px]   font-serif">
        ...
        <div className="mt-10 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
          {experiences.map((exp, idx) => (
            ...
            >
              <h3 className="font-semibold  text-gray-900 font-serif text-[16px] sm:text-[18px]  md:text-[18px] text-left ">
                {exp.title}
              </h3>
              <p className="mt-3 text-gray-600  leading-relaxed   font-serif text-left  text-[13px] sm:text-[14px]  md:text-[14px]">
                {exp.description}
              </p>
            </div>
          ))}
       ...
       <main className="bg-[#FAF9F6] flex items-center justify-center md:px-20  py-3   sm:py-5 md:py-5 px-4">
      <div className=" w-full">
        <div className="bg-[#111] rounded-2xl p-8 md:p-12 flex flex-col md:flex-row items-center gap-10">
          {/* Left Content */}
          <div className="flex-1 text-center md:text-left">
            <h2 className=" font-bold text-white font-serif text-left text-[22px] sm:text-[28px]  md:text-[32px] ">
              Start Planning Your Retreat Today
            </h2>
            <p className="mt-4 text-gray-300  md:text-base leading-relaxed text-left text-[13px] sm:text-[18px]  md:text-[18px]   font-serif">
            ...
            <button className="mt-4 px-6 py-3 bg-gradient-to-r from-blue-500 to-blue-400 text-white font-medium rounded-full shadow-md hover:shadow-lg transition">
